...
function love.load()
    ...
    -- Velocity and position for the ball when the game starts
    ballX = VIRTUAL_WIDTH/2 - BALL_WIDTH
    ballY = VIRTUAL_HEIGHT/2 - BALL_HEIGHT
    -- Use Lua ternary to assign delta X
    -- Randomly assign ball movement speed
...
function love.update(dt)
    ...
    if gameState == 'play' then 
        ...
        ballX = ballX + (dt * ballDX)
        ballY = ballY + (dt * ballDY)
    end
end
